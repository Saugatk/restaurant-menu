...
export default function MenuApp() {
  ...
  const menuData = {
    ...
    'Salad': [
      ...
      { name: 'Fruit Salad, Small Plate', price: '250', image: '/images/Fruit Salad small plate.jpg' },
    ...
    'Sekuwa': [
      { name: 'Buff Sekuwa', price: '350', image: '/images/buff sekuwa.jpg' },
      { name: 'Chicken Sekuwa', price: '350', image: '/images/chichken sekuwa.jpg' },
      { name: 'Mutton Sekuwa', price: '500', image: '/images/mutton sekuwa.jpg' },
      { name: 'Pork Sekuwa', price: '450', image: '/images/pork fry.jpg' },
    ],
    'Khaja Set': [
