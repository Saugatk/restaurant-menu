...
export default function MenuApp() {
  ...
  const menuData = {
    ...
    'Non Veg Items (Chicken)': [
      ...
      { name: 'Chicken Drumstick, per piece', price: '180', image: '/images/chicken drumstick, per piece.jpg' },
      ...
      { name: 'Tawa Chicken', price: '350', image: '/images/chicken taas.jpg' },
      { name: 'Buffalo Wings', price: '380', image: '/images/buffalo wings.jpg' },
      { name: 'Chicken Hot Wings', price: '380', image: '/images/chicken hot wings.jpg' },
      { name: 'Chicken Wings', price: '150', image: '/images/chicken wing.jpg' },
    ],
    'Momo': [
      { name: 'Chicken Momo Steam', price: '140', image: '/images/buff momo.jpg' },
      ...
      { name: 'Chicken Momo C', price: '150', image: '/images/chicken momo c.jpg' },
      ...
      { name: 'Buff Momo C', price: '150', image: '/images/buff momo c.jpg' },
      ...
      { name: 'Veg Momo C', price: '140', image: '/images/veg momo c.jpg' },
    ],
    'Chowmein': [
      { name: 'Veg Chowmein', price: '120', image: '/images/veg chowmein.jpeg' },
      { name: 'Buff Chowmein', price: '150', image: '/images/mix chowmin.jpg' },
    ...
    'Burger': [
      ...
      { name: 'Buff Burger', price: '300', image: '/images/buff burger.jpg' },
    ...
    'Nepali Thakali Khana': [
      ...
      { name: 'Egg', price: '300', image: '/images/egg nepali thali khana.jpg' },
    ...
    'Milk Shake': [
      { name: 'Vanilla Milk Shake', price: '250', image: '/images/vanilla milkshake.jpeg' },
      { name: 'Chocolate Milk Shake', price: '275', image: '/images/chocolate milk shake.jpeg' },
      { name: 'Strawberry Milk Shake', price: '300', image: '/images/strawberry milkshake.jpeg' },
      { name: 'Oreo Milkshake', price: '300', image: '/images/oreo milkshake.jpeg' },
    ],
    'Juice': [
    ...
    'Beer': [
      ...
      { name: 'Gorkha 5000', price: '400', image: '/images/5000 beer 650mnl.jpg' },
    ],
    'Wine': [
    ...
    'Pork': [
      ...
      { name: 'Pork Sekuwa, Small / Large', price: '350 / 450', image: '/images/mutton sekuwa.jpg' },
    ],
    'Buff': [
      { name: 'Sukuti', price: '300', image: '/images/sukuti.jpg' },
      ...
      { name: 'Tawa Buff', price: '380', image: '/images/tawa buff.jpg' },
    ],
    'Sekuwa': [
      ...
      { name: 'Pork Sekuwa', price: '180', image: '/images/pork fry.jpg' },
    ],
    'Khaja Set': [
    ...
    'Sadeko': [
      ...
      { name: 'Buff Sadeko', price: '130', image: '/images/buff sadeko.jpg' },
      ...
      { name: 'Cucumber Sadeko', price: '100', image: '/images/cucumber sadeko.jpg' },
